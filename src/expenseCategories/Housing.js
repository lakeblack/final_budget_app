    ...
    return (
      <div>
        <div style={styles.container} onClick={this.handleClick.bind(this)}>
          <p style={styles.title}>Housing</p>
        ...
        {this.state.subs.map((expense, index) =>
          <div className="expenses housing" key={index} style={{display: "none"}}>
            <p>
              <span>{expense.name}:</span>
              <input type='range' value={expense.value} min={0} max={2000} step={5} onChange={this.handleChange.bind(this, expense, index)}/>
