...
class Transportation extends Component{
  ...
  componentDidMount() {
      this.ref = base.syncState(`${localStorage.UID}/myTransportation`, {
        context: this,
        state: 'subs',
        asArray: true
      });
      this.ref2 = base.syncState(`${localStorage.UID}/myExpenses/6/1`, {
        context: this,
        state: 'total'
      });
   }
    ...
    return (
      <div>
        <div style={styles.container} onClick={this.handleClick.bind(this)}>
          <p style={styles.title}>Transportation</p>
